...
<div>
<p class="text-sm text-gray-500 mb-2">Current Banner</p>
...
{{-- UPLOAD IMAGE --}}
<div>
<label class="font-semibold text-gray-700">Replace Banner Image</label>
...
class="px-6 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white shadow transition">
💾 Update
</button>
