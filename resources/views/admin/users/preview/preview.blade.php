...
<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
    ...
    <div>
        ...
        <p class="text-gray-500 mt-1">
            {{ __('Validate uploaded CSV before importing users') }}
        </p>
    </div>
...
<th class="w-16 px-6 py-4 text-left">{{ __('No') }}</th>

@if($role == 'student')
<th class="px-6 py-4 text-left">{{ __('NIM') }}</th>
<th class="px-6 py-4 text-left">{{ __('Name') }}</th>
<th class="px-6 py-4 text-left">{{ __('Major') }}</th>
<th class="px-6 py-4 text-left">{{ __('Faculty') }}</th>

@elseif($role == 'lecturer')
<th class="px-6 py-4 text-left">{{ __('NIP') }}</th>
<th class="px-6 py-4 text-left">{{ __('Name') }}</th>
<th class="px-6 py-4 text-left">{{ __('Degree') }}</th>
<th class="px-6 py-4 text-left">{{ __('Department') }}</th>

@elseif($role == 'staff')
<th class="px-6 py-4 text-left">{{ __('Employee ID') }}</th>
<th class="px-6 py-4 text-left">{{ __('Name') }}</th>
<th class="px-6 py-4 text-left">{{ __('Job Position') }}</th>
<th class="px-6 py-4 text-left">{{ __('Department') }}</th>
@endif

<th class="px-6 py-4 text-left">{{ __('Status') }}</th>
<th class="px-6 py-4 text-left">{{ __('Message') }}</th>
